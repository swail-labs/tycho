#!/usr/bin/env python3
"""Stamp the Homebrew formula template with a release's version + sha256 sums.

The template (`tycho.rb`, beside this file) carries `REPLACE_ME_*` markers; the `homebrew-publish`
release job runs this against the `SHA256SUMS` asset the `release` job attached, then
